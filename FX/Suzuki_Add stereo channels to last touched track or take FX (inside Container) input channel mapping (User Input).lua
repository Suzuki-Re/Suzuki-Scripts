-- @description Add stereo channels to last touched track or take FX (inside Container) input channel mapping (User Input)
-- @author Suzuki
-- @license GPL v3
-- @version 1.0
...
local function TakeFX_SetPin(a, b, c, d, e, f, g, h)
  ...
  r.TakeFX_SetPinMappings(take, fxidx, 0, 1, low32r + b, high32r + f) -- #4 pin 1 righ
...
local function TrackFX_SetPin(a, b, c, d, e, f, g, h)
  ...
  r.TrackFX_SetPinMappings(track, fxidx, 0, 1, low32r + b, high32r + f) -- #4 pin 1 righ
